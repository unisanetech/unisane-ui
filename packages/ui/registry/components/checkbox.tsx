          ...
          <span
            ...
            className={cn(
              ...
              resolvedInvalid
                ...
                : 'border-control-outline group-hover:border-on-surface peer-checked:bg-primary peer-checked:border-primary peer-indeterminate:bg-primary peer-indeterminate:border-primary',
