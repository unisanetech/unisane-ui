...
export { useOverlayBehavior, type UseOverlayBehaviorOptions } from './use-overlay-behavior';
...
export const stateLayer = {
  ...
  surfaceVariant: 'hover:bg-on-surface-variant/[0.08] active:bg-on-surface-variant/[0.12]',
