...
import { DENSITY_STYLES, DENSITY_UTILITY_COLUMN_WIDTHS, type Density } from '@/components/ui/data-table/constants';
import { useColumnDrag } from '@/components/ui/data-table/hooks/ui/use-column-drag';
import { useI18n } from '@/components/ui/data-table/i18n';
import { first, last, safeArrayAccess } from '@/components/ui/data-table/utils/type-guards';
import { HeaderCell } from '@/components/ui/data-table/components/header/header-cell';
import { GroupHeaderRow } from '@/components/ui/data-table/components/header/group-header-row';

// Re-export sub-components for direct use
export { ResizeHandle } from '@/components/ui/data-table/components/header/resize-handle';
export { ColumnMenu } from '@/components/ui/data-table/components/header/column-menu';
export { HeaderCell } from '@/components/ui/data-table/components/header/header-cell';
export { GroupHeaderRow } from '@/components/ui/data-table/components/header/group-header-row';
export { SortControl } from '@/components/ui/data-table/components/header/sort-control';
