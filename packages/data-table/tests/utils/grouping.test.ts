...
describe('buildNestedGroups', () => {
  ...
  describe('expansion state', () => {
    it('should call isGroupExpanded with group ID', () => {
      buildNestedGroups(testData, ['category'], 0, null, mockIsExpanded, emptyAggregationColumns);
  ...
  describe('edge cases', () => {
    ...
    it('should sort groups alphabetically', () => {
      ...
      const groups = buildNestedGroups(unsortedData, ['category'], 0, null, mockIsExpanded, []);
...
describe('grouping integration', () => {
  it('should produce correct structure for rendering', () => {
    ...
    const groups = buildGroupedData({
      ...
      aggregationColumns: [{ key: 'amount', header: 'Total', aggregation: 'sum' }],
    });
