...
import {
  ...
  getNestedValueSafe,
  setNestedValue,
} from '../../src/utils/get-nested-value';
...
describe('getNestedValue', () => {
  ...
  describe('default values', () => {
    ...
    it('should return default value for null input object', () => {
      expect(getNestedValue(null as unknown as object, 'path', { defaultValue: 'default' })).toBe(
        'default',
      );
    });
    ...
    it('should return default value for undefined input object', () => {
      expect(
        getNestedValue(undefined as unknown as object, 'path', { defaultValue: 'default' }),
      ).toBe('default');
    });

    it('should return default value for non-object input', () => {
      expect(
        getNestedValue('string' as unknown as object, 'path', { defaultValue: 'default' }),
      ).toBe('default');
      expect(getNestedValue(123 as unknown as object, 'path', { defaultValue: 'default' })).toBe(
        'default',
      );
    });
  });
