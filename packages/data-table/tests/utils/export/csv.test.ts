...
import { exportToCSV, toCSVString } from '../../../src/utils/export/csv';
...
describe('CSV export edge cases', () => {
  ...
  it('should handle large numbers', () => {
    ...
    const dataWithLargeNum: RowWithLargeNum[] = [{ id: '1', value: 123456789012345 }];

    const columns: Column<RowWithLargeNum>[] = [{ key: 'value', header: 'Value' }];
  ...
  it('should handle empty strings', () => {
    const dataWithEmpty: TestRow[] = [{ id: '1', name: '', email: 'test@test.com', age: 30 }];
