...
} from '../../../src/utils/export/safe-export';
import { createErrorHub } from '../../../src/errors/error-hub';
import { ExportError } from '../../../src/errors/runtime-errors';
...
vi.mock('../../../src/utils/export/utils', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../../../src/utils/export/utils')>();
  return {
    ...actual,
    downloadFile: vi.fn(),
  };
