...
import type { Column, ColumnGroup } from '../../src/types/column';
import { AggregateDataTableError } from '../../src/errors/aggregate-error';
import { DuplicateColumnKeyError, InvalidColumnKeyError } from '../../src/errors/column-errors';
...
describe('validateColumns', () => {
  ...
  it('should warn about very wide columns', () => {
    const columns: Column<TestRow>[] = [{ key: 'name', header: 'Name', width: 600 }];
  ...
  it('should warn about negative width', () => {
    const columns: Column<TestRow>[] = [{ key: 'name', header: 'Name', width: -10 }];
...
describe('findDuplicateColumnKeys', () => {
  ...
  it('should find duplicates in nested column groups', () => {
    const columns: Array<Column<TestRow> | ColumnGroup<TestRow>> = [
      ...
      {
        header: 'Details',
        children: [{ key: 'name', header: 'Name Again' }],
      },
    ];
...
describe('getAllColumnKeys', () => {
  ...
  it('should return keys from nested column groups', () => {
    const columns: Array<Column<TestRow> | ColumnGroup<TestRow>> = [
      ...
      {
        header: 'Contact',
        children: [{ key: 'email', header: 'Email' }],
      },
      { key: 'age', header: 'Age' },
    ];
