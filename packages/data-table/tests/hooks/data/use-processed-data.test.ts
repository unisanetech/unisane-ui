...
import { useProcessedData } from '../../../src/hooks/data/use-processed-data';
import type { Column, FilterState, FilterValue, MultiSortState } from '../../../src/types';
...
function createDefaultOptions(
  overrides: Partial<Parameters<typeof useProcessedData<TestRow>>[0]> = {},
) {
  return {
    data: testData,
    searchText: '',
...
describe('useProcessedData', () => {
  ...
  describe('basic functionality', () => {
    ...
    it('should return empty array for empty data', () => {
      const { result } = renderHook(() => useProcessedData(createDefaultOptions({ data: [] })));
