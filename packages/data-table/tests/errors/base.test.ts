...
import { DataTableError, DataTableErrorCode, DEFAULT_ERROR_SEVERITY } from '../../src/errors/base';
import { ErrorSeverity } from '../../src/errors/severity';
...
describe('DEFAULT_ERROR_SEVERITY', () => {
  ...
  it('should assign CRITICAL to data integrity errors', () => {
    expect(DEFAULT_ERROR_SEVERITY[DataTableErrorCode.DUPLICATE_ROW_ID]).toBe(
  ...
  it('should assign WARNING to non-critical errors', () => {
    expect(DEFAULT_ERROR_SEVERITY[DataTableErrorCode.INCOMPATIBLE_OPTIONS]).toBe(
...
describe('DataTableError', () => {
  describe('constructor', () => {
    it('should create error with message and code', () => {
      const error = new DataTableError('Test error', DataTableErrorCode.INVALID_DATA_FORMAT);
    ...
    it('should use default severity from error code', () => {
      const error = new DataTableError('Duplicate row', DataTableErrorCode.DUPLICATE_ROW_ID);

      expect(error.severity).toBe(ErrorSeverity.CRITICAL);
    });

    it('should allow custom severity override', () => {
      const error = new DataTableError('Test error', DataTableErrorCode.DUPLICATE_ROW_ID, {
    ...
    it('should store cause', () => {
      ...
      const error = new DataTableError('Wrapped error', DataTableErrorCode.DATA_FETCH_FAILED, {
        cause,
      });
  ...
  describe('shouldTriggerBoundary', () => {
    ...
    it('should return false for ERROR and WARNING', () => {
      const errorSeverity = new DataTableError('Test', DataTableErrorCode.INVALID_CONFIG, {
        severity: ErrorSeverity.ERROR,
      });

      const warningSeverity = new DataTableError('Test', DataTableErrorCode.INVALID_CONFIG, {
        severity: ErrorSeverity.WARNING,
      });
  ...
  describe('isRecoverable', () => {
    ...
    it('should return true for non-FATAL errors', () => {
      ...
      severities.forEach((severity) => {
        const error = new DataTableError('Test', DataTableErrorCode.INVALID_CONFIG, { severity });
