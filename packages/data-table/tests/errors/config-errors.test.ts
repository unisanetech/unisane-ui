...
describe('IncompatibleOptionsError', () => {
  describe('construction', () => {
    it('should create error with two options', () => {
      ...
      expect(error.message).toBe(
        'Incompatible options: virtualization and grouping. Cannot use both features together.',
      );
    ...
    it('should create error with multiple options', () => {
      ...
      expect(error.message).toBe(
        'Incompatible options: optionA and optionB and optionC. Only one can be active.',
      );
    });
