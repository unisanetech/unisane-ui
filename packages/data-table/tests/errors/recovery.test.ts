...
const createTestError = (code: string, context?: Record<string, unknown>): DataTableError => {
  return new DataTableError('Test error', code as typeof DataTableErrorCode.FILTER_ERROR, {
    context,
  });
};
