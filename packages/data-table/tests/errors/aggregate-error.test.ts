...
import {
  ...
  flattenErrors,
  isAggregateError,
} from '../../src/errors/aggregate-error';
import { DataTableError, DataTableErrorCode } from '../../src/errors/base';
...
describe('AggregateDataTableError', () => {
  describe('constructor', () => {
    it('should create aggregate error with multiple errors', () => {
      const errors = [createError('Error 1'), createError('Error 2'), createError('Error 3')];
  ...
  describe('hasErrorCode', () => {
    it('should return true when code exists', () => {
      const errors = [createError('Error', DataTableErrorCode.INVALID_COLUMN_KEY)];
  ...
  describe('hasSeverity', () => {
    ...
    it('should return false when severity does not exist', () => {
      const errors = [createError('Error', DataTableErrorCode.INVALID_CONFIG, ErrorSeverity.ERROR)];
  ...
  describe('hasFatalError', () => {
    it('should return true when fatal error exists', () => {
      const errors = [createError('Fatal', DataTableErrorCode.INVALID_CONFIG, ErrorSeverity.FATAL)];
...
describe('ErrorCollector', () => {
  ...
  describe('addAll', () => {
    it('should add multiple errors', () => {
      const collector = new ErrorCollector();
      collector.addAll([createError('Error 1'), createError('Error 2'), createError('Error 3')]);
