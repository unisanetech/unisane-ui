...
import { ContextNotFoundError, ProviderMissingError } from '../../src/errors/context-errors';
...
describe('ProviderMissingError', () => {
  ...
  describe('common provider names', () => {
    ...
    it('should handle a named provider', () => {
      const error = new ProviderMissingError('DataTableProvider', 'StyledCell');
