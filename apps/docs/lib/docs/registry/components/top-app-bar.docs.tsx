...
const TopAppBarHeroVisual = () => (
  <HeroBackground tone="surface">
    ...
    <div className="relative bg-surface w-80 h-60 rounded-sm shadow-xl overflow-hidden border border-outline-variant">
      {/* Top App Bar */}
      <div className="h-16 px-4 flex items-center justify-between border-b border-outline-variant bg-surface">
