...
export const sliderDoc: ComponentDoc = {
  ...
  // ─── CHOOSING SECTION ──────────────────────────────────────────────────────
  choosing: {
    description: 'Sliders can display values with labels and tick marks for precise selection.',
    columns: {
      emphasis: 'Type',
      component: 'Example',
    ...
    rows: [
      {
        ...
        rationale: 'Simple value selection without visible feedback.',
      ...
      },
      {
        ...
        rationale: 'Shows current value on hover/drag for precise selection.',
      ...
      },
      {
        ...
        rationale: 'Discrete steps with visual markers for fixed options.',
      ...
      },
      {
        ...
        rationale: 'Shows value but prevents interaction.',
  ...
  // ─── HIERARCHY SECTION ─────────────────────────────────────────────────────
  hierarchy: {
    description: 'Sliders can be customized with labels, ticks, and step values.',
    items: [
      {
  ...
  // ─── PLACEMENT SECTION ─────────────────────────────────────────────────────
  placement: {
    description: 'Sliders are commonly used in settings panels, media controls, and range filters.',
    examples: [
      {
        ...
        visual: (
          <Card variant="outlined" padding="md" className="mx-auto max-w-72">
            ...
            <div className="space-y-5">
              <div>
                <div className="text-body-small mb-2 flex justify-between">
      ...
      },
      {
        title: 'Media player',
        visual: (
          <Card variant="outlined" padding="lg" className="mx-auto max-w-72">
            <div className="flex flex-col items-center gap-4">
              <div className="text-body-small text-on-surface-variant">Now Playing</div>
              <div className="w-full">
                <Slider defaultValue={35} />
              </div>
              <div className="text-body-small text-on-surface-variant flex w-full justify-between">
                <span>1:24</span>
                <span>3:45</span>
              </div>
            </div>
