...
const MonthPickerHeroVisual = () => (
  <HeroBackground tone="secondary">
    <div className="bg-surface border-outline-variant w-80 rounded-sm border p-6 shadow-xl">
      ...
      <div className="bg-surface-container shadow-2 mt-2 rounded-sm p-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          {['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'].map((month) => (
            <div
              key={month}
              className={`text-label-medium rounded-sm px-3 py-2 text-center ${
...
export const monthPickerDoc: ComponentDoc = {
  ...
  placement: {
    description: 'Month pickers are commonly used in forms that need period-level precision.',
    previewDefaults: {
      overflow: 'visible',
      minHeight: 'lg',
      align: 'start',
