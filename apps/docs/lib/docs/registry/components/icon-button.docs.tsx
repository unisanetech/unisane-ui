...
const IconButtonHeroVisual = () => (
  <HeroBackground tone="primary">
    {/* Mock App Bar */}
    <div className="bg-surface w-80 rounded-sm shadow-xl overflow-hidden border border-outline-variant">
      {/* Top App Bar */}
      <div className="h-16 flex items-center justify-between px-4 bg-surface border-b border-outline-variant">
      ...
      <div className="p-4">
        <div className="grid grid-cols-3 gap-2">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="aspect-square bg-surface-container-high rounded-sm relative group">
    ...
    examples: [
      {
        ...
        visual: (
          <div className="bg-surface rounded-sm border border-outline-variant overflow-hidden max-w-80 mx-auto">
      ...
      },
      {
        ...
        visual: (
          <div className="flex items-start gap-3 p-4 border border-outline-variant rounded-sm w-full max-w-xs bg-surface">
