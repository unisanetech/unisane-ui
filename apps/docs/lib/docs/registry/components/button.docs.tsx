...
const ButtonHeroVisual = () => (
  <HeroBackground tone="primary">
    {/* Mock Screen */}
    <div className="bg-surface border-outline-variant relative flex h-80 w-72 flex-col overflow-hidden rounded-sm border shadow-xl">
      {/* Mock Image Header */}
      <div className="bg-surface-container-high relative h-36">
        <div className="from-scrim-soft absolute inset-0 bg-linear-to-t to-transparent" />
      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="bg-outline-subtle mb-3 h-2 w-14 rounded" />
        <h3 className="text-title-medium text-on-surface mb-2 font-medium">Top 5 tea houses</h3>
...
export const buttonDoc: ComponentDoc = {
    ...
    examples: [
      {
        ...
        visual: (
          <div className="bg-surface border-outline-variant mx-auto max-w-80 rounded-sm border p-6 shadow-sm">
            <div className="mb-4">
      ...
      },
      {
        ...
        visual: (
          <Card variant="elevated" padding="none" className="mx-auto max-w-80 overflow-hidden">
            <div className="bg-surface-container-high h-28 w-full" />
            <div className="p-4">
              <div className="bg-outline-subtle mb-3 h-5 w-3/4 rounded" />
              <div className="bg-outline-muted mb-2 h-4 w-full rounded" />
              <div className="bg-outline-muted mb-5 h-4 w-2/3 rounded" />
  ...
  accessibility: {
    screenReader: [
      ...
      'Native disabled buttons use the disabled attribute; disabled asChild elements use aria-disabled and leave the tab order.',
      'Leading and trailing icons are decorative when they use the Icon default; the text remains the accessible name.',
    ],
  },
