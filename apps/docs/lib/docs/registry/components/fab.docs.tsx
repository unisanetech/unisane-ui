...
const FabHeroVisual = () => (
  <HeroBackground tone="primary">
    {/* Mock Email App */}
    <div className="bg-surface w-80 h-96 rounded-xl shadow-xl overflow-hidden border border-outline-variant">
      {/* App Bar */}
    ...
    examples: [
      {
        ...
        visual: (
          <div className="relative bg-surface-container rounded-xl h-48 max-w-80 mx-auto border border-outline-variant">
            <div className="absolute bottom-4 right-4">
              <Fab
                variant="primary"
                aria-label="Add item"
