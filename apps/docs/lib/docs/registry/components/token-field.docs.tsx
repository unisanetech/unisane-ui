...
import { Button, Card, TokenField } from "@unisane/ui";
...
const TokenFieldHeroVisual = () => {
  ...
  return (
    <HeroBackground tone="surface">
      <div className="relative bg-surface w-96 max-w-full rounded-sm shadow-xl overflow-hidden border border-outline-variant">
...
export const tokenFieldDoc: ComponentDoc = {
    ...
    examples: [
      {
        title: "Resume skills",
        visual: (
          <Card variant="outlined" padding="md" className="max-w-96 mx-auto">
  ...
  implementation: {
    ...
    code: `import { TokenField } from "@unisane/ui";
import { useState } from "react";
