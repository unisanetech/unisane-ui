...
const BreadcrumbHeroVisual = () => (
  <HeroBackground tone="surface">
    {/* Mock Breadcrumb */}
    <div className="bg-surface border-outline-variant relative rounded-sm border px-5 py-3 shadow-xl">
      <div className="flex items-center gap-2">
        <span className="text-label-medium text-on-surface-variant hover:text-primary cursor-pointer font-medium transition-colors">
          Home
        </span>
        ...
        <span className="material-symbols-outlined text-outline text-[14px]">chevron_right</span>
        <span className="text-label-medium text-on-surface font-medium">Headphones</span>
      </div>
    </div>
  </HeroBackground>
);
...
export const breadcrumbDoc: ComponentDoc = {
  ...
  // ─── CHOOSING SECTION ──────────────────────────────────────────────────────
  choosing: {
    description: 'Breadcrumbs can include links, the current page, and ellipsis for long paths.',
    columns: {
      emphasis: 'Element',
      component: 'Example',
    ...
    rows: [
      {
        emphasis: 'Link',
        component: <BreadcrumbLink href="/products">Products</BreadcrumbLink>,
        rationale: 'Clickable ancestor pages in the hierarchy.',
        examples: 'Parent categories, Sections',
      },
      {
        emphasis: 'Current',
        component: <BreadcrumbPage>Current Page</BreadcrumbPage>,
        rationale: 'The current page (not clickable).',
      ...
      },
      {
        ...
        rationale: 'Collapses middle items in long paths.',
  ...
  // ─── HIERARCHY SECTION ─────────────────────────────────────────────────────
  hierarchy: {
    description: 'Breadcrumbs are composed of items, links, separators, and the current page.',
    items: [
      {
        component: (
          <Breadcrumb>
  ...
  // ─── PLACEMENT SECTION ─────────────────────────────────────────────────────
  placement: {
    description: 'Breadcrumbs are typically placed at the top of the page content area.',
    examples: [
      {
      ...
      props: [
        {
          ...
          type: 'ReactNode',
          required: true,
          description: 'Link and separator elements.',
        },
      ],
    },
    {
      ...
      props: [
        ...
        },
        {
          name: 'asChild',
          type: 'boolean',
          description: 'Use child as link element (e.g., Next.js Link).',
        },
      ],
    },
    {
  ...
  implementation: {
    ...
    code: `import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbPage, BreadcrumbSeparator } from "@/components/ui/breadcrumb";
