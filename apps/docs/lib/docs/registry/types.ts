...
export interface ExampleDef {
  ...
  code?: string;
  /** Optional preview-stage overrides for this specific example */
  preview?: PreviewStageConfig;
}
...
export interface PlacementExample {
  ...
  caption?: string;
  /** Optional preview-stage overrides for this specific placement example */
  preview?: PreviewStageConfig;
}
...
export interface PlacementSectionDef {
  /** Section description */
  description?: string;
  /** Default preview-stage behavior for placement examples */
...
export interface ComponentDoc {
  ...
  /** Stage behavior for the hero preview container */
