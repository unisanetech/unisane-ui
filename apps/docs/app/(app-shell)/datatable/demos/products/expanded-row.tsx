  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
      <div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Icon symbol="qr_code" className="text-on-surface-variant h-4 w-4" />
            <span className="text-body-small font-mono">{row.sku}</span>
          </div>
          <div className="flex items-center gap-2">
            <Icon symbol="category" className="text-on-surface-variant h-4 w-4" />
            <span className="text-body-small capitalize">
              {row.category} / {row.subcategory}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <Icon symbol="scale" className="text-on-surface-variant h-4 w-4" />
      ...
      <div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Icon symbol="sell" className="text-on-surface-variant h-4 w-4" />
          ...
          <div className="flex items-center gap-2">
            <Icon symbol="trending_up" className="text-primary h-4 w-4" />
      ...
      <div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Icon symbol="inventory_2" className="text-on-surface-variant h-4 w-4" />
            <span className="text-body-small">{row.quantity} units in stock</span>
          </div>
          <div className="flex items-center gap-2">
            <Icon symbol="visibility" className="text-on-surface-variant h-4 w-4" />
            <span className="text-body-small capitalize">{row.visibility.replace(/_/g, ' ')}</span>
          </div>
          <div className="flex items-center gap-2">
            <Icon symbol="schedule" className="text-on-surface-variant h-4 w-4" />
      ...
      <div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-body-small">
              {row.rating.toFixed(1)} rating ({row.reviewCount} reviews)
            </span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            <Icon symbol="update" className="text-on-surface-variant h-4 w-4" />
